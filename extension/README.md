...
| `HighlightWindow(wm_class, label)` → `bool` | Highlight a window by WM class; returns whether a window was found |
| `UpdateLabel(label)` | Change the floating label while a highlight is active |
